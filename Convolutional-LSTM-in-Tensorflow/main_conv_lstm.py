...
def network(inputs, hidden):
  conv1 = ld.conv2d(inputs, (1,1), (1,1), 8, "encode_1")
  # conv2
  #conv2 = ld.conv2d(conv1, (1,2), (1,2), 8, "encode_2")
  # conv3
  #conv3 = ld.conv2d(conv2, (1,2), (1,2), 8, "encode_3")
  # conv4
  ...
  with tf.variable_scope('conv_lstm', initializer = tf.random_uniform_initializer(-.01, 0.1)):
    cell = BasicConvLSTMCell.BasicConvLSTMCell([16,128], [4,4], 8)
    if hidden is None:
      hidden = cell.zero_state(FLAGS.batch_size, tf.float32) 
    y_1, hidden = cell(y_0, hidden)
  
  with tf.variable_scope('conv_lstm_2', initializer = tf.random_uniform_initializer(-.01, 0.1)):  
    cell2 = BasicConvLSTMCell.BasicConvLSTMCell([16,128], [8,8], 8)
    y_2, hidden = cell2(y_1, hidden)
    
  with tf.variable_scope('conv_lstm_3', initializer = tf.random_uniform_initializer(-.01, 0.1)):  
    cell3 = BasicConvLSTMCell.BasicConvLSTMCell([16,128], [4,4], 8)
    y_3, hidden = cell3(y_2, hidden)
 
  # conv5
  #conv5 = ld.transpose_conv_layer(y_3, (1,1), (1,1), 8, "decode_5")
  # conv6
  #conv6 = ld.transpose_conv_layer(conv5, (4,4), (1,2), 8, "decode_6")
  # conv7
  #conv7 = ld.transpose_conv_layer(conv6, (1,2), (1,2), 8, "decode_7")
  # x_1 
  conv7 = y_3
  x_1 = ld.transpose_conv_layer(conv7, (1,1), (1,1), 1, "decode_8", True)
  #x_1 = ld.conv2d(conv7, (1,1), (1,1), 1, "decode_8", True)
